...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_iters', type=int, default=250, help='how many iterations until prompted for a checkpoint (value of -1 means no checkpoint)')
    
    # Miscellaneous.
    parser.add_argument('--log_step', type=int, default=10)
    parser.add_argument('--loss_avg_len', type=int, default=20)
